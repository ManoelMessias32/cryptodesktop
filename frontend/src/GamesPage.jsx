...
const GameControls = ({ onControlPress, onFullscreen }) => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', marginTop: '25px', background: '#1e293b', padding: '20px', borderRadius: '15px', maxWidth: '420px', margin: '25px auto 0 auto' }}>
